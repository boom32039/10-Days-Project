...
export class createAll1634325928351 implements MigrationInterface {
    name = 'createAll1634325928351'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "users" ("id" SERIAL NOT NULL, "username" character varying NOT NULL, "password" character varying NOT NULL, "name" character varying NOT NULL, "E_mail" character varying NOT NULL, "tel" character varying NOT NULL, "shopname" character varying NOT NULL, "gender" character varying NOT NULL, "birth_date" character varying NOT NULL, "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
